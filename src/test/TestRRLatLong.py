...
(edge_id, osm_source, osm_target, source_ratio, node_lon, node_lat) = dataManager.getClosestEdge(52.5123759867379, 13.3799182055483, "berlin")
source = createVirtualNodeEdge(graph, node_lat, node_lon, edge_id, osm_source, osm_target, source_ratio)
print(source)

targets = set()
(edge_id, osm_source, osm_target, source_ratio, node_lon, node_lat) = dataManager.getClosestEdge(52.5033010992503, 13.4070841962566, "berlin")
