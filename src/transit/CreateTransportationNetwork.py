...
class CreateTransportationNetwork:
    ...
    def __init__(self, region, roadGraph, mbr):
        self.region = region
        self.graph = MultimodalNetwork()
        self.osm_mapping = roadGraph.getOsmMapping()
        self.mbr = mbr
        ...
        self.current_node_id = roadGraph.getNumNodes()
...
if __name__ == '__main__':
    ...
    loadRoad = LoadRoadNetwork(region, graph)
    loadRoad.load()
    ...
    createTransportation = CreateTransportationNetwork(region, graph, loadRoad.getMbr())  
    createTransportation.create()