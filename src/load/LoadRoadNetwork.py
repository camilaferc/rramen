...
class LoadRoadNetwork:
    ...
    def load(self):
        ...
        sql = """SELECT id, osm_source_id, osm_target_id, km, kmh, ST_X(source_location), ST_Y(source_location), 
        ...
        try:
            ...
            while row is not None:
                (edge_id, osm_source_id, osm_target_id, length, speed, x_source, y_source, 
                ...
                modes = {self.graph.PRIVATE, self.graph.PEDESTRIAN}
                ...
                #if graph.graph[node_from][node_to]:
                #    print("Edge already exists:" + node_from + "," + node_to)
    ...
    def generateTravelTimeFunction(self, length, speed):
        list_speeds = {0:1, 1:1, 2:1, 3:1, 4:1, 5:1, 6:0.8, 7:0.6, 8:0.6, 9:0.6, 10:0.8, 11:0.8, 12:0.7, 
                       13:0.8, 14:0.8, 15:0.8, 16:0.7, 17:0.5, 18:0.4, 19:0.5, 20:0.7, 21: 0.8, 22:0.9, 23:1}
        x = []
        y = []
        for i in range(24):
